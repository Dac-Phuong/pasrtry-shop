                ...
                <form wire:submit.prevent="submit" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework">
                    <div class="col-12 mb-3 fv-plugins-icon-container">
                        ...
                        <input type="text" id="modalRoleName" required wire:model.defer="role" class="form-control"
                            placeholder="Nhập tên vai trò" tabindex="-1">
                        @error('role')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" class="check-all"
                                                    id="selectAll">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" wire:model.defer="permissions"
                                                        type="checkbox" value="create-customer" id="customerManagementAdd">
                                                ...
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" wire:model.defer="permissions"
                                                        type="checkbox" value="update-customer" id="customerManagementUpdate">
                                            ...
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input checkbox-item"
                                                        wire:model.defer="permissions" type="checkbox"
                                                        value="list-order" id="finManagementRead">
                                                ...
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input checkbox-item"
                                                        wire:model.defer="permissions" type="checkbox"
                                                        value="status-order" id="finManagementWrite">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input checkbox-item"
                                                        wire:model.defer="permissions" type="checkbox"
                                                        value="detail-order" id="finManagementCreate">
