            ...
            <div class="modal-body mb-3">
                ...
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit.prevent="submit"
                    ...
                    <div class="mb-4">
                        <div class="card-body">
                            <div class="mb-2">
                                <label class="form-label" for="basic-icon-default-user">Tên người dùng</label>
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text"><i class="ti ti-user"></i></span>
                                    <input type="text" id="basic-icon-default-user" wire:model.defer="name"
                                        class="form-control" placeholder="Nhập tên người dùng" aria-label="john.doe"
                            ...
                            <div class="col-md-4 user_plan w-100">
                                <label class="form-label" for="multicol-password">Vai trò người dùng</label>
                                <select id="UserPlan" wire:model.defer="role_name" class="form-select text-capitalize" fdprocessedid="ibeieu">
                                    <option value="">Hủy vai trò</option>
